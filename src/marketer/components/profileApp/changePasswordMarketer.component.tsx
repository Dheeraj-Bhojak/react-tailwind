...
const ChangePasswordMarketer: React.FC = () => {
  ...
  const togglePasswordVisibility = (keyName: keyof PasswordState) => {
    const values = showPassword[keyName];
        ...
        <div className="p-3">
          <div className="w-full xl:flex ">
            <div className="xl:w-2/3 w-full  border-1 rounded border-gray-200 xs:mt-6 xl:mt-0 shadow-md p-2  min-h-[420px] xl:mx-2 xl:">
              ...
              <form className="m-1" onSubmit={handleSubmitChangePassword}>
                  ...
                  <div className="sm:w-7/12 ">
                    <div className="w-full mx-3 mb-3">
                      ...
                      <Link
                        ...
                        to={"/marketer-app/security/forgot-password"}>
                        Forgot Password ?
                      </Link>
                      <div className="flex">
...
export default ChangePasswordMarketer;
